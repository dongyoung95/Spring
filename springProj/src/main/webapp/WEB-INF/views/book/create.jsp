...
<form action="/create" method="post" enctype="multipart/form-data">
	...
	<p>출판일 : <input type="date" name="pubDt" required />
	</p>
	<p>
		<p>저자 :</p>
		<p id="pWriters">
			<span>
				<input type="text" name="writerVOList[0].wrId" value="WR0001" />
				<input type="text" name="writerVOList[0].wrName" value="개똥이" />
			</span><br />
			<span>
				<input type="text" name="writerVOList[1].wrId" value="WR0002" />
				<input type="text" name="writerVOList[1].wrName" value="수현" />
			</span><br />
			<span>
				<input type="text" name="writerVOList[2].wrId" value="WR0003" />
				<input type="text" name="writerVOList[2].wrName" value="찬혁" />
			</span><br />
		</p> 
	</p>
	<p id="body_content">
