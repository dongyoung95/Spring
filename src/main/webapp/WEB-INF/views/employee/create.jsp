...
요청방식 : post
-->
<form name="frm" action="/employee/create" method="post" enctype="multipart/form-data">
	<p><input type="text" name="eName" placeholder="사원명을 입력해주세요"
		 required /></p>
	<p><input type="text" name="eAddress" placeholder="주소를 입력해주세요"
		required /></p>
	<p><input type="text" name="eTelno" placeholder="연락처를 등록해주세요"
		required /></p>
	<p>
		<label for="ePosition1">부장</label>
		<input type="radio" id="ePosition1" name="ePosition" value="부장" />
		<label for="ePosition2">차장</label>
		<input type="radio" id="ePosition2" name="ePosition" value="차장" />
		<label for="ePosition3">과장</label>
		<input type="radio" id="ePosition3" name="ePosition" value="과장" />
		<label for="ePosition4">대리</label>
		<input type="radio" id="ePosition4" name="ePosition" value="대리" />
		<label for="ePosition5">사원</label>
		<input type="radio" id="ePosition5" name="ePosition" value="사원" />
	</p>
	<p>
		<select name="eDept" id="eDept">
	...
	<p>
		<span>
			<input type="text" name="cardVOList[0].eEmpno" value="E024" />
			<input type="text" name="cardVOList[0].cardNum" value="11111-22-333333" />
			<input type="text" name="cardVOList[0].cardYm" value="202501" />
		</span><br />
		<span>
			<input type="text" name="cardVOList[1].eEmpno" value="E024" />
			<input type="text" name="cardVOList[1].cardNum" value="11111-33-666666" />
			<input type="text" name="cardVOList[1].cardYm" value="202503" />
		</span><br />
		<span>
			<input type="text" name="cardVOList[2].eEmpno" value="E024" />
			<input type="text" name="cardVOList[2].cardNum" value="11111-55-777777" />
			<input type="text" name="cardVOList[2].cardYm" value="202507" />
		</span><br />
	</p>
